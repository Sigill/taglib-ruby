...
#define SWIGTYPE_p_TagLib__RIFF__AIFF__File swig_types[4]
#define SWIGTYPE_p_TagLib__RIFF__AIFF__Properties swig_types[5]
#define SWIGTYPE_p_TagLib__StringList swig_types[6]
...
fail:
  Ruby_Format_OverloadedError( argc, 2, "Properties.new", 
    ...
    "    Properties.new(TagLib::RIFF::AIFF::File *file, TagLib::AudioProperties::ReadStyle style)\n");
...
SWIGINTERN void
free_TagLib_RIFF_AIFF_Properties(void *self) {
    TagLib::RIFF::AIFF::Properties *arg1 = (TagLib::RIFF::AIFF::Properties *)self;
...
fail:
  Ruby_Format_OverloadedError( argc, 3, "File.new", 
    ...
    "    File.new(IOStream *stream, bool readProperties, TagLib::RIFF::AIFF::Properties::ReadStyle propertiesStyle)\n"
...
_wrap_File_properties(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_TagLib__RIFF__AIFF__File, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::RIFF::AIFF::File const *","properties", 1, self )); 
  }
  arg1 = reinterpret_cast< TagLib::RIFF::AIFF::File * >(argp1);
  result = ((TagLib::RIFF::AIFF::File const *)arg1)->properties();
...
_wrap_File_propertiese___(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_TagLib__RIFF__AIFF__File, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::RIFF::AIFF::File *","setProperties", 1, self )); 
  }
  arg1 = reinterpret_cast< TagLib::RIFF::AIFF::File * >(argp1);
