...
#define SWIGTYPE_p_TagLib__Vorbis__File swig_types[7]
#define SWIGTYPE_p_TagLib__Vorbis__Properties swig_types[8]
...
SWIGINTERN void
free_TagLib_Vorbis_Properties(void *self) {
    TagLib::Vorbis::Properties *arg1 = (TagLib::Vorbis::Properties *)self;
...
fail:
  Ruby_Format_OverloadedError( argc, 3, "File.new", 
    ...
    "    File.new(IOStream *stream, bool readProperties, TagLib::Vorbis::Properties::ReadStyle propertiesStyle)\n"
...
_wrap_File_properties(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_TagLib__Vorbis__File, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::Vorbis::File const *","properties", 1, self )); 
  }
  arg1 = reinterpret_cast< TagLib::Vorbis::File * >(argp1);
  result = ((TagLib::Vorbis::File const *)arg1)->properties();
...
_wrap_File_propertiese___(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_TagLib__Vorbis__File, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "TagLib::Vorbis::File *","setProperties", 1, self )); 
  }
  arg1 = reinterpret_cast< TagLib::Vorbis::File * >(argp1);
